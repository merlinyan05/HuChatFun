...
输入：data/v3/step2_segmented/*.jsonl
输出：data/v3/step3_scored/scored.jsonl（所有 segment 打分后合并）
      data/v3/step3_scored/passed.jsonl（过线的 segment）
...
INPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step2_segmented"
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step3_scored"
...
CATCHPHRASES = {
    ...
    "你废了": 2, "安卓逻辑": 2, "安卓人": 2, "安卓学历": 2,
    "纯纯低论": 2, "纯纯废物": 2, "纯纯安卓": 2,
    "安卓机": 2, "安卓水": 2, "安卓网": 2, "安卓味": 2,
    "降维打击": 2, "割韭菜": 2,
    # ── 毒舌/攻击性（1 分）──
    "废了": 1, "没救了": 1, "救不了": 1, "活该": 1,
    "傻": 1, "蠢": 1, "弱智": 1, "低能": 1,
    "丢人": 1, "丢不丢人": 1, "寒碜": 1,
    "脑子": 1, "脑回路": 1, "智商": 1,
    "不配": 1, "你配吗": 1,
    "逆天": 1, "离谱": 1, "搞笑": 1,
    "完蛋": 1, "完犊子": 1, "凉了": 1, "没戏": 1,
    "拉胯": 1, "太拉了": 1, "太低了": 1, "太差了": 1,
    "狗都不": 1, "一言难尽": 1, "一塌糊涂": 1, "一无是处": 1,
    "投胎": 1, "重开": 1, "下辈子": 1,
    "穷": 1, "没钱": 1, "穷鬼": 1, "屌丝": 1,
    "韭菜": 1, "底层": 1, "阶级": 1,
    "打螺丝": 1, "流水线": 1, "进厂": 1,
    ...
    # ── 口头禅/语气词（1 分）──
    "知道吧": 1, "能明白吗": 1, "明白吗": 1,
    "我告诉你": 1, "你给我记住": 1, "你听我说": 1,
    "咱有什么说什么": 1, "说白了": 1, "说实话": 1,
    "格局": 1, "无语": 1, "绝了": 1, "服了": 1,
    "低论": 1, "匪夷所思": 1, "爱莫能助": 1,
    "生活愉快": 1, "不寒碜": 1,
}
...
def main():
    ...
    print(f"过线（≥40）：{len(passed):,}（{len(passed)/len(all_records)*100:.1f}%）")
    print(f"分数分布：")
