...
输入：data/v3/step3_scored/passed.jsonl
输出：data/v3/step4_pairs/train_pairs.jsonl
...
INPUT_FILE = Path(__file__).parent.parent.parent / "data" / "v3" / "step3_scored" / "passed.jsonl"
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step4_pairs"
