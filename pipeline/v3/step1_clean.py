...
处理范围：corpus/HuChenFeng-1.1/2023年* + 2024年* + 2025年* 下的非 INC .md 文件
输出到：data/v3/step1_cleaned/，每个源文件对应一个同名 .txt
...
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step1_cleaned"
