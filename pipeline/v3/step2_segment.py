...
输入：data/v3/step1_cleaned/*.txt
输出：data/v3/step2_segmented/*.jsonl
...
INPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step1_cleaned"
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "step2_segmented"
