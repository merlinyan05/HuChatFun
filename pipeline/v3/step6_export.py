...
输入：data/v3/step4_pairs/train_pairs.jsonl
输出：data/v3/final/train.json（90%）
      data/v3/final/eval.json（10%）
...
INPUT_FILE = Path(__file__).parent.parent.parent / "data" / "v3" / "step4_pairs" / "train_pairs.jsonl"
OUTPUT_DIR = Path(__file__).parent.parent.parent / "data" / "v3" / "final"
